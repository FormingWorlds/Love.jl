...
module TidalLoveNumbers
    ...
    # Example
        ...
        Y = TidalLoveNumbers.clats;
        X = TidalLoveNumbers.lons;
        P20 = 0.5 .* (3 .* cos.(Y).^2 .- 1)
        P22 = 3 .* (1. .- cos.(Y).^2)
...
#
    ...
    The grid is internal to TidalLoveNumbers, but can be accessed with 

        TidalLoveNumbers.clats[:] # colatitude grid
        TidalLoveNumbers.lons[:]  # longitude grid
    """
